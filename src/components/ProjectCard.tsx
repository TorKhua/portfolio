...
import foto from "/public/TODAS.jpg";
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full flex gap-2 bg-l_bg4 dark:bg-d_bg2 p-3 rounded-t-xl">
        <a className="w-4 h-4 rounded-full dark:bg-l_red bg-d_red"></a>
        <a className="w-4 h-4 rounded-full dark:bg-l_yellow bg-d_yellow"></a>
        <a className="w-4 h-4 rounded-full dark:bg-l_green bg-d_green"></a>
      </div>

      {/* Contenido principal */}
      <div className="w-full bg-l_bg1 dark:bg-d_bg4 p-3 rounded-b-xl flex flex-wrap justify-between items-center gap-4">
